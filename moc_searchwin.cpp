...
static const char qt_meta_stringdata_SearchWin[] = {
    "SearchWin\0openNewLink(QListWidgetItem*)\0"
    "item\0\0"
};
...
void SearchWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->openNewLink((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData SearchWin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SearchWin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SearchWin,
      qt_meta_data_SearchWin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SearchWin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SearchWin))
